...
var calculateArea = function(geojsonFeatureCollection) {
    /*
    ...
    */
    var coords = geojsonFeatureCollection.features[0].geometry.coordinates;
...
var calculateCenter = function (geojsonFeatureCollection) {
 var latlngs = geojsonFeatureCollection.features[0].geometry.coordinates[0];
 //console.log(latlngs);
 var latSum = _.reduce(latlngs, function(total, latlng) {
      return total + latlng[1];
  }, 0.0);
  var lngSum = _.reduce(latlngs, function(total, latlng) {
      return total + latlng[0];
  }, 0.0);
  var center = {
